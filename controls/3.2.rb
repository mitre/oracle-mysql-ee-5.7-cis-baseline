control "3.2" do
  ...
  tag "fix": ""
  tag "Default Value": "Execute the following command for each log file location requiring corrected permissions and ownership:
      chmod 660 <log file>
  ...
  describe directory("#{log_bin_basename}") do
    it { should exist }
